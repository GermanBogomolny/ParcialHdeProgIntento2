...
namespace Stix.Controllers
{
    public class FoodController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameFood,DescriptionFood,IsVeganFood,IsVegetarianFood,Price,Type")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameFood,DescriptionFood,IsVeganFood,IsVegetarianFood,Price,Type")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
